...
public class RoleAuthourization {
	...
	public void role () throws InterruptedException
	{
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html[1]/body[1]/div[2]/div[1]/app-administration[1]/app-users[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[3]/ng-select[1]/div[1]/span[1]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html[1]/body[1]/div[2]/div[1]/app-administration[1]/app-users[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[3]/ng-select[1]/ng-dropdown-panel[1]/div[1]/div[2]/div[6]/span[1]")).click();
		Thread.sleep(2000);
		...
		String Expected ="This User Is Already Exists.";
