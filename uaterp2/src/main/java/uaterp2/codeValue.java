...
public class codeValue {
	...
	public void creatededuction1 () throws InterruptedException
	{
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("/html[1]/body[1]/div[2]/nav[1]/div[1]/ul[1]/li[9]/ul[1]/li[1]/ul[1]/li[2]/a[1]")).click();
		Thread.sleep(2000);

		driver.findElement(By.xpath("/html[1]/body[1]/div[2]/div[1]/app-administration[1]/app-code-value[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/button[1]")).click();
		Thread.sleep(2000);	
	
		String Actualltext = driver.findElement( By.xpath("/html[1]/body[1]/div[2]/div[1]/app-administration[1]/app-code-value[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/h6[1]")).getText();
		String Expected ="Select Field Code-Value";
		Assert.assertEquals(Actualltext, Expected," ");
